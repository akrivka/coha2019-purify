<template>
  <div class="animated fadeIn">
      ...
      <b-col sm="12" lg="12">
        <b-card no-body class="bg-primary">
          <b-card-body class="pb-0">
            <h4 class="mb-0">PURITY INDEX</h4>
            <p>Is your route healthy?</p>
          </b-card-body>
    ...
    <b-card>
      <b-row>
        <b-col sm="5">
          <h4 id="traffic" class="card-title mb-0">MAP</h4>
    ...
    <b-row>
      <b-col sm="12" lg="1">
        <b-card no-body class="bg-info">
          <b-card-body class="pb-0">
            <h4 class="mb-0">1x10<sup>8</sup></h4>
      ...
      <b-col sm="6" lg="1">
        <b-card no-body class="bg-info">
          <b-card-body class="pb-0">
            <h4 class="mb-0">1x10<sup>8</sup></h4>
            <p><strong>Birch pollen</strong></p>
          </b-card-body>
          <card-line3-chart-example chartId="card-chart-03" class="chart-wrapper" style="height:70px;" height="70"/>
        </b-card>
      </b-col>
      <b-col sm="6" lg="1">
        <b-card no-body class="bg-info">
          <b-card-body class="pb-0">
            <h4 class="mb-0">1x10<sup>8</sup></h4>
            <p><strong>Olive pollen</strong></p>
          </b-card-body>
          <card-line3-chart-example chartId="card-chart-03" class="chart-wrapper" style="height:70px;" height="70"/>
        </b-card>
      </b-col>
      <b-col sm="6" lg="1">
        <b-card no-body class="bg-info">
          <b-card-body class="pb-0">
            <h4 class="mb-0">1x10<sup>8</sup></h4>
            <p><strong>Grass pollen</strong></p>
          </b-card-body>
          <card-line3-chart-example chartId="card-chart-03" class="chart-wrapper" style="height:70px;" height="70"/>
        </b-card>
      </b-col>
    ...
    <b-card>
      <b-row>
        <b-col sm="5">
          <h4 id="traffic" class="card-title mb-0">Histogram</h4>
