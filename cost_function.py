...
#img = np.random.rand(1,2500)
img = np.ones(2500)*10
img = np.resize(img, (50,50))
k = 10
img = cv2.resize(img,(img.shape[0]*k, img.shape[1]*k))

p1 = [10.0,0.0]
p2 = [40.0,10.0]
buff = createLineIterator(p1,p2,img)
print('buff: ', buff)
print('cost', computeCost(buff))
